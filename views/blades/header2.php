...
<head>
    ...
    <link rel="shortcut icon" type="x-icon" href="../files/imgs/logo.png">
...
<body style="background-color: #F5F5F5">
    <div class="container-fluid px-0">
        ...
        <div class="container-fluid">
            ...
            <a href="../index.php" class="text-decoration-none text-dark"><i class="bi bi-arrow-bar-left" id="backheader"></i></a>
        </div>
        </nav>